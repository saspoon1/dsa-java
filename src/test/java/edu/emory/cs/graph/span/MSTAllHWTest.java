...
public class MSTAllHWTest {
    ...
    public void test() {
        ...
        graphs.add(getGraph1a()); //1: 0
        graphs.add(getGraph2a()); //2: 0
        graphs.add(getGraph3a()); //3: 1
        graphs.add(getGraph3b()); //4: 2
        graphs.add(getGraph3c()); //5:
        graphs.add(getGraph4a()); //6:
        graphs.add(getGraph4b()); //7:
        graphs.add(getGraph4c()); //8:
        graphs.add(getGraph5a()); //9:
